...
export class MetricMineral extends CustomEntity {
  ...
  @OneToMany(() => MetricAlias, (metricAlias) => metricAlias.metricMineral)
  aliases: MetricAlias[];
  ...
  @ManyToOne(() => Metric, (metric) => metric.metricMinerals)
  @JoinColumn([{ name: "metric_id", referencedColumnName: "id" }])
  metric: Metric;

  @ManyToOne(() => Mineral, (mineral) => mineral.metricMinerals)

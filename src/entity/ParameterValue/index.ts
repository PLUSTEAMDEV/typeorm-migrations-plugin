...
export class ParameterValue extends CustomEntity {
  ...
  @ManyToOne(() => Distinction, (distinction) => distinction.parameterValues)
  @JoinColumn([{ name: "distinction_id", referencedColumnName: "id" }])
  distinction: Distinction;

  @ManyToOne(() => Location, (location) => location.parameterValues)
  @JoinColumn([{ name: "location_id", referencedColumnName: "id" }])
  location: Location;

  @ManyToOne(() => Parameter, (parameter) => parameter.parameterValues)

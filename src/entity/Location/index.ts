...
export class Location extends CustomEntity {
  ...
  @ManyToOne(() => SpaceUnit, (spaceUnit) => spaceUnit.locations, {
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  })
  ...
  @OneToMany(() => ParameterValue, (parameterValue) => parameterValue.location)
  parameterValues: ParameterValue[];

  @OneToMany(() => SpaceTime, (spaceTime) => spaceTime.location)

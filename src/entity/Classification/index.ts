...
export class Classification extends CustomEntity {
  ...
  @ManyToOne(() => Classification, (classification) => classification.children)
  ...
  @OneToMany(() => Factor, (factor) => factor.classification)
  factors: Factor[];

  @OneToMany(() => Factor, (factor) => factor.classification2)
  factors2: Factor[];

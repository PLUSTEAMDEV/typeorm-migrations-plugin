 ...
 */
import { customField, Extension, MigrationFunctions } from "@/utils/database-migrations/interfaces";
 ...
 */
function getMigrationFunctionsForCustomField(field: customField): MigrationFunctions {
...
export function updateCalculatedFields(fields: customField[]): MigrationFunctions[] {
  return fields.map((field: customField) => getMigrationFunctionsForCustomField(field));
}
